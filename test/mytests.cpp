...
{
    fprintf(stderr, "BankAccountStartsEmpty\n");
    EXPECT_EQ(0, account->balance);
}

TEST_F(BankAccountTest, BankAccountCanBeDeposited)
{
    account->deposit(100);
...
struct account_state
{
    ...
    {
        return os << "initial_balance: " << obj.initial_balance << " withdraw_amount: " << obj.withdraw_amount << " final_balance: " << obj.final_balance << " success: " << obj.success;
    }
};
